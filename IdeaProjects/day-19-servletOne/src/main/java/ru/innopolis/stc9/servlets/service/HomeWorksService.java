...
public class HomeWorksService {
    ...
    public HomeWorks getHWAnswer(int timetable_id){
        return homeWork.getHomeWorkAnswer(timetable_id);
    }

    public boolean isHWEmpty(int timetable_id) {
        return homeWork.isHomeWorkEmpty(timetable_id);
    }
